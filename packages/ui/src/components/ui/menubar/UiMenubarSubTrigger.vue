...
defineOptions({ name: 'UiMenubarSubTrigger', inheritAttrs: false });

interface UiMenubarSubTriggerProps {
  disabled?: boolean;
  inset?: boolean;
}

const props = withDefaults(defineProps<UiMenubarSubTriggerProps>(), {
  disabled: false,
  inset: false,
});
