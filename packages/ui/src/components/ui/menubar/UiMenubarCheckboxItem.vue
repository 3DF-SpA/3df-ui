...
defineOptions({ name: 'UiMenubarCheckboxItem', inheritAttrs: false });

interface UiMenubarCheckboxItemProps {
  checked?: boolean;
  disabled?: boolean;
}

const props = withDefaults(defineProps<UiMenubarCheckboxItemProps>(), {
  checked: false,
  disabled: false,
});
