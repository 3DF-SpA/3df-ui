  ...
  <UiPopover>
    <UiPopoverTrigger>
      <button
        ...
        :class="
          cn(
            'inline-flex h-10 w-full min-w-[240px] items-center justify-start gap-2 rounded-md border border-input bg-background px-3 py-2 text-left text-sm ring-offset-background transition-colors',
            'hover:bg-accent/50',
