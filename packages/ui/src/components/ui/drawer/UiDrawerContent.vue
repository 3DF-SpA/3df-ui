...
function onPointerDown(e: PointerEvent) {
  // Only allow dragging from the handle area or top section
  ...
  <Teleport to="body">
    <div v-if="isVisible" class="fixed inset-0 z-50">
      ...
      <div
        ...
        :class="
          cn(
            'fixed inset-x-0 bottom-0 z-50 flex max-h-[96dvh] flex-col rounded-t-xl border-ui border-border',
            'bg-popover',
      ...
      >
        ...
        <div
          data-drawer-handle
          class="mx-auto mt-4 h-1.5 w-12 shrink-0 cursor-grab rounded-full bg-muted-foreground/20 active:cursor-grabbing"
        />
