...
const classes = computed(() => cn('text-lg font-semibold text-foreground', attrs.class));
</script>

<template>
  <component :is="as" v-bind="restAttrs" :id="sheet.titleId" :class="classes" data-sheet="title">
    <slot />
  </component>
</template>
