...
const menubarProps = computed<PropItem[]>(() => [
  {
    ...
    type: 'string',
    default: t('views.menubar.autoGenerated'),
  ...
  },
  {
    ...
    type: 'string',
    default: t('views.menubar.required'),
  ...
  <div class="flex flex-col gap-10">
    ...
    <DocShowcase :title="showcaseTitle('complete')" :code="completeCode">
      ...
      <p class="text-muted-foreground mt-3 text-xs">
        {{ t('demo.menubarStatus', { bookmarks: showBookmarks, urls: showFullUrls, profile: selectedProfile }) }}
      </p>
    </DocShowcase>
    ...
    <section class="flex flex-col gap-4">
      <h2 class="text-sm font-semibold">{{ t('views.menubar.anatomy') }}</h2>
