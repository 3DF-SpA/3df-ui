...
<template>
  <div class="flex min-h-screen flex-col gap-12 p-8">
    ...
    <!-- Glass Blur Card (preview) -->
    <section class="flex flex-col gap-4">
      <h2 class="text-muted-foreground text-sm font-medium">Glass Blur Card (preview)</h2>

      <!-- Background uses theme tokens so it adapts to any theme -->
      <div
        class="bg-muted relative flex items-center justify-center overflow-hidden rounded-3xl"
        style="min-height: 480px"
      >
        <!-- Blobs use theme colors — subtle and natural -->
        <div
          class="pointer-events-none absolute -left-20 top-8 h-72 w-72 rounded-full opacity-40"
          style="background: var(--color-primary); filter: blur(80px)"
        />
        <div
          class="pointer-events-none absolute -right-16 -top-10 h-64 w-64 rounded-full opacity-30"
          style="background: var(--color-accent); filter: blur(70px)"
        />
        <div
          class="pointer-events-none absolute -bottom-10 left-1/3 h-56 w-56 rounded-full opacity-25"
          style="background: var(--color-ring); filter: blur(60px)"
        />
        <div
          class="pointer-events-none absolute bottom-12 right-10 h-40 w-40 rounded-full opacity-20"
          style="background: var(--color-primary); filter: blur(50px)"
        />

        <!-- Glass panel -->
        <div
          class="border-border/30 relative z-10 m-6 grid w-full max-w-3xl grid-cols-1 gap-8 rounded-2xl border p-10 md:grid-cols-[1fr_1.1fr]"
          style="
            background: color-mix(in srgb, var(--color-background) 60%, transparent);
            backdrop-filter: blur(24px) saturate(1.3);
            -webkit-backdrop-filter: blur(24px) saturate(1.3);
            box-shadow:
              0 8px 32px color-mix(in srgb, var(--color-foreground) 6%, transparent),
              inset 0 1px 0 color-mix(in srgb, var(--color-background) 50%, transparent);
          "
        >
          <!-- Left: text content -->
          <div class="flex flex-col justify-center gap-3">
            ...
            <div class="flex flex-col gap-1">
              <h3 class="text-foreground text-4xl font-extrabold leading-tight">
                What is plasma?
              </h3>
              <p class="text-muted-foreground/70 text-[1.6rem] font-semibold">
                What happens to it?
              </p>
              <p class="text-muted-foreground/60 text-[1.6rem] font-semibold">
                How does it help?
              </p>
            </div>

            <p class="text-foreground/80 mt-3 max-w-sm text-sm leading-relaxed">
              Plasma is the liquid part of your blood that scientists turn into life-saving medicine.
              Your body replaces it fast, so you can donate twice a week and get paid each time.
            </p>

            <div class="mt-4">
              <button
                class="border-border/40 text-primary rounded-full border px-7 py-2.5 text-sm font-semibold transition-all hover:scale-[1.02] hover:shadow-lg active:scale-[0.98]"
                style="
          ...
          <!-- Right: image with glass border -->
          <div class="flex items-center justify-center">
            <div
              class="border-border/30 overflow-hidden rounded-2xl border"
              style="
                box-shadow:
                  0 16px 48px color-mix(in srgb, var(--color-foreground) 10%, transparent),
                  0 4px 12px color-mix(in srgb, var(--color-foreground) 5%, transparent);
              "
            >
              <img
                src="https://images.unsplash.com/photo-1614935151651-0bea6508db6b?w=600&h=450&fit=crop"
                alt="Plasma illustration"
      ...
      <div class="grid max-w-4xl gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Para proyectos personales y experimentación.</CardDescription>
            <div class="mt-2">
        ...
        <Card class="border-primary relative border-2">
          ...
          <CardHeader>
            ...
            <CardDescription>Para equipos pequeños y freelancers.</CardDescription>
            <div class="mt-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Para organizaciones con necesidades avanzadas.</CardDescription>
            <div class="mt-2">
    ...
    <section class="flex flex-col gap-4">
      ...
      <div class="grid max-w-4xl gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Card class="overflow-hidden">
          ...
          <CardContent>
            <div class="flex items-baseline gap-2">
              <span class="text-lg font-bold">$239.00</span>
              <span class="text-muted-foreground text-sm line-through">$299.00</span>
            </div>
          </CardContent>
          <CardFooter>
            <Button class="w-full" size="sm">Agregar al carrito</Button>
        ...
        <Card class="overflow-hidden">
          ...
          <CardContent>
            <div class="flex items-baseline gap-2">
              <span class="text-lg font-bold">$89.00</span>
            </div>
          </CardContent>
          <CardFooter>
            <Button class="w-full" size="sm">Agregar al carrito</Button>
        ...
        <Card class="flex flex-col overflow-hidden sm:flex-row">
          ...
          <div class="flex flex-1 flex-col">
            <CardHeader>
              ...
              <CardDescription>
                Cámara instantánea con flash integrado y modos de exposición automáticos. Incluye
                pack de 10 fotos.
              </CardDescription>
            </CardHeader>
            <CardContent>
    ...
    <!-- Feature cards (estilo landing / marketing) -->
    <section class="flex flex-col gap-4">
        ...
        <Card class="border-0 bg-amber-50 shadow-none dark:bg-amber-950/30">
            ...
            <div class="mb-4 overflow-hidden rounded-lg bg-white p-4 shadow-sm dark:bg-white/10">
              <div class="flex flex-col gap-3">
                <div class="flex gap-2">
                  ...
                  <div class="h-2 w-10 rounded-full bg-amber-200/60"></div>
                </div>
                <div class="flex gap-2">
                  <div class="h-2 w-20 rounded-full bg-amber-300/40"></div>
                  <div class="h-2 w-8 rounded-full bg-amber-200/40"></div>
                </div>
                <div class="flex gap-2">
                  <div class="h-2 w-12 rounded-full bg-amber-300/40"></div>
                ...
                >
                  ...
                  <div class="flex items-center gap-1.5">
                    <span
                      class="flex size-5 items-center justify-center rounded-full bg-amber-400 text-[10px] font-bold text-white"
                      >✓</span
                    >
          ...
          <CardHeader class="pt-0">
            ...
            <CardDescription class="text-sm">
              Visualiza el panorama completo de cada interacción: chat, email, teléfono y video, de
              un vistazo.
            </CardDescription>
          </CardHeader>
        </Card>
          ...
          <CardContent class="pt-6">
            <div class="mb-4 overflow-hidden rounded-lg bg-white p-4 shadow-sm dark:bg-white/10">
              <div class="flex flex-col gap-2">
                ...
                <div class="flex items-center gap-2">
                  <div class="size-7 rounded-full bg-teal-200 dark:bg-teal-700"></div>
                  <div class="flex flex-col">
                    <span class="text-xs font-medium">Simón Gregory</span>
                    <span class="text-[10px] text-teal-600 dark:text-teal-400"
                      >QA score ↘ 1.25 this week</span
                    >
                  </div>
                </div>
                <div class="mt-1 flex flex-col gap-1.5">
                  ...
                  >
                    <span
                      ...
                      >💬</span
                    >
                    <span class="truncate text-[11px]">Assisting a Tech-Savvy Customer</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="flex flex-col gap-2">
                ...
                <div class="mb-1 flex items-center gap-3">
                  <div class="flex items-center gap-1">
                    <span class="inline-block size-2.5 rounded-sm bg-emerald-500"></span>
                    <span class="text-[10px]">Reps</span>
                  </div>
                  <div class="flex items-center gap-1">
                    <span class="inline-block size-2.5 rounded-sm bg-teal-400"></span>
                    <span class="text-[10px]">Bots</span>
                  </div>
                </div>
                <div class="flex items-end gap-1.5">
                  <div class="flex w-full flex-col items-center gap-0.5">
                    <div class="h-10 w-full rounded-t-sm bg-emerald-400/60"></div>
                    <div class="h-6 w-full rounded-t-sm bg-teal-300/60"></div>
                  </div>
                  <div class="flex w-full flex-col items-center gap-0.5">
                    <div class="h-12 w-full rounded-t-sm bg-emerald-400/70"></div>
                    <div class="h-8 w-full rounded-t-sm bg-teal-300/70"></div>
                  </div>
                  <div class="flex w-full flex-col items-center gap-0.5">
                    <div class="h-8 w-full rounded-t-sm bg-emerald-400/50"></div>
                    <div class="h-10 w-full rounded-t-sm bg-teal-300/50"></div>
                  </div>
                  <div class="flex w-full flex-col items-center gap-0.5">
                    <div class="h-14 w-full rounded-t-sm bg-emerald-500/80"></div>
                    <div class="h-10 w-full rounded-t-sm bg-teal-400/80"></div>
                  </div>
                  <div class="flex w-full flex-col items-center gap-0.5">
                    <div class="h-16 w-full rounded-t-sm bg-emerald-500"></div>
                    <div class="h-12 w-full rounded-t-sm bg-teal-400"></div>
                  </div>
                </div>
              </div>
            </div>
